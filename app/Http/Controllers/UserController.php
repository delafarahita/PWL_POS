...
public function update(Request $request, string $id)
{
    $request->validate([
        ...
        // dan bernilai unik di tabel m_users kolom username kecuali untuk user dengan id yang sedang diedit
        'username' => 'required|string|unique:m_users,username,'.$id.',user_id',
        'nama' => 'required|string|max:100',           // nama harus diisi, berupa string, dan maksimal 100 karakter
        'password' => 'nullable|min:5|', // password harus diisi, string, dan maksimal 100 karakter
        'level_id' => 'required|integer'               // level_id harus diisi dan merupakan angka
    ]);
