...
class LevelController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        $levels = LevelModel::all(); // Melewatkan data level ke view
        ...
        return view('level.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'level' => $level, 'levels' => $levels, 'activeMenu' => $activeMenu]); // Memasukkan variabel $levels ke dalam view
    }
